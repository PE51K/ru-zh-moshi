...
def main():
    ...
    parser.add_argument('--jsonl', type=str, default="dataset/new/converted_generated_data.jsonl", 
                        help='Path to JSONL file (default to generated data path)')
    parser.add_argument('--voices', type=str, default="dataset/new/voices", help='Directory containing voice samples')
    parser.add_argument('--assistant-voice', type=str, help='Specific voice file for assistant (relative to voices directory)')
    parser.add_argument('--output', type=str, default="dataset/new/audio", 
        ...
        try:
            ...
            for turn_idx, message in enumerate(conversation):
                ...
                if "language_segments" in message and message["language_segments"]:
                    ...
                    raise ValueError(f"No language segments found in message for conversation {actual_idx}, turn {turn_idx+1}")
